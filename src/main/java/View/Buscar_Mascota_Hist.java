...
import View.Buscar_Mascota.ComboItem;

public class Buscar_Mascota_Hist extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Buscar_Mascota_Hist frame = new Buscar_Mascota_Hist();
	 ...
	 * Create the frame.
	 */
	public Buscar_Mascota_Hist(final String perfil) {
