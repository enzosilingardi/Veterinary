...
public class Buscar_Cliente_Pre extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Buscar_Cliente_Pre frame = new Buscar_Cliente_Pre();
	 ...
	 * Create the frame.
	 */
	public Buscar_Cliente_Pre() {                                  //Crea la ventana
		...
		btnSeleccionar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Presupuesto pre = new Presupuesto(nom,dni,dir);           // abre la ventana Presupuesto, recibiendo como parametro el nombre, dni y direccion del cliente
				pre.setVisible(true);
				dispose();
				
			}
		});
		btnSeleccionar.setBounds(314, 407, 135, 23);
