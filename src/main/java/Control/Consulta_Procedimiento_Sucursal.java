...
public class Consulta_Procedimiento_Sucursal {
	...
	public static int existe(Object procedimiento, Object sucursal) {
		Connection cn = null;
	...
	public static Connection agregar(Object proced, Object sucursal, String nombreP, String nombreS) {
		...
		try {
			...
			if(result > 0){
                ...
                ControlFiles.addContent("Se ha asociado el procedimiento "+nombreP+" a la sucursal "+nombreS);
	...
	public static Connection eliminar(int id, String nombreP, String nombreS) {
		int result = 0;
		...
		try {
			...
			if(result > 0){
                ...
                ControlFiles.addContent("Se ha eliminado el procedimiento "+nombreP+" de la sucursal "+nombreS);
