...
public class Control_Sucursales {
	...
	public static int existe(String direccion) {
		Connection cn = null;
	...
	public static Connection agregar(String direccion) {
		...
		try {
			...
			if(existe(direccion)!=0) {     //Revisa si la sucursal ya existe
	...
	public static Connection modificar(String direccion, int id) {
		int result = 0;
	...
	public static Connection eliminar(int id, String nombre) {
		...
		try {
			...
			if(result > 0){
                ...
                ControlFiles.addContent("Se ha eliminado la sucursal "+nombre);
